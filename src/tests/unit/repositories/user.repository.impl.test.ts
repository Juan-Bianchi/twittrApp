...
describe('create', () => {
  it('should create a new user', async () => {
    ...
    const recieved = await repository.create(
      new SignupInputDTO('challenge_prueba_juan@outlook.com', 'userJuan', 'Aa12345@')
    );
...
describe('getByIdPublicOrFollowed', () => {
  it('should get the user as it is being followed or has public profile', async () => {
    ...
    const recieved = await repository.getByIdPublicOrFollowed(
