...
beforeEach(() => {
  ...
  message1 = {
    id: '1d3b7816-8c3f-42de-813a-3778871a2235',
  ...
  message2 = {
    id: '25e7fc8f-0e8c-4cdd-9c46-8636fd772277',
...
describe('saveMessage', () => {
  it('should save the message', async () => {
    ...
    const recieved = await service.saveMessage(
  ...
  it('should throw an exception if there is at minimum a missing parameter', async () => {
    ...
    await expect(
      service.saveMessage('83538af2-24e4-4435-bc36-a049183828d8', '3ac84483-20f1-47f3-8be1-43ab2db46ad0', '')
  ...
  it('should throw an exception if users are not following each other', async () => {
    ...
    await expect(
      service.saveMessage('83538af2-24e4-4435-bc36-a049183828d8', '3ac84483-20f1-47f3-8be1-43ab2db46ad0', 'test')
...
describe('loadChat', () => {
  it('should load the chat', async () => {
    ...
    const recieved = await service.loadChat(
      '83538af2-24e4-4435-bc36-a049183828d8',
      '3ac84483-20f1-47f3-8be1-43ab2db46ad0'
    );
    expect(recieved).toEqual(expected);
  ...
  it('should throw an exception if users are not following each other', async () => {
    ...
    jest.spyOn(followMockService, 'isFollowing').mockResolvedValue(false);
    await expect(
      service.loadChat('83538af2-24e4-4435-bc36-a049183828d8', '3ac84483-20f1-47f3-8be1-43ab2db46ad0')
