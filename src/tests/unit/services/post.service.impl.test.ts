...
describe('createPost', ()=> {
    it('should create a new post', async () => {
        ...
        const recieved = await service.createPost('3ac84483-20f1-47f3-8be1-43ab2db46ad0', {content: 'this is another test twitt.', images: []})
...
describe('delete', ()=> {
    ...
    it('should throw an exception if post id is not correct', async () => {
        ...
        jest.spyOn(mockRepository, 'getById').mockResolvedValue(null);
        await expect(service.deletePost('3ac84483-20f1-47f3-8be1-43ab2db46ad0', '921cce9e-cfe6-4636-a0ca-9df133d38527')).rejects.toThrow(NotFoundException)
    });
