...
beforeEach(() => {
  ...
  comment1 = {
    id: 'f1989782-88f9-4055-99fc-135611c1992a',
  ...
  comment2 = {
    id: '64b3fb58-b612-4af0-9916-f84a5439fb4e',
...
describe('create', () => {
  it('should create a new comment', async () => {
    ...
    const recieved = await service.createComment('3ac84483-20f1-47f3-8be1-43ab2db46ad0', {
      content: 'this is another test twitt.',
      images: [],
      postCommentedId: '921cce9e-cfe6-4636-a0ca-9df133d38527',
    });
  ...
  it('should throw an exception if post id is not correct', async () => {
    ...
    await expect(
      service.createComment('3ac84483-20f1-47f3-8be1-43ab2db46ad0', {
        content: 'this is another test twitt.',
        images: [],
        postCommentedId: '921cce9e-cfe6-4636-a0ca-9df133d38527',
      })
...
describe('getCommentById', () => {
  it('should get the comment by the provided id', async () => {
    ...
    const expected = new PostDTO(comment1);
    const recieved = await service.getCommentById(
      '3ac84483-20f1-47f3-8be1-43ab2db46ad0',
      'f1989782-88f9-4055-99fc-135611c1992a'
    );
  ...
  it('should throw an exception if user id is not correct', async () => {
    ...
    await expect(
      service.getCommentById('3ac84483-20f1-47f3-8be1-43ab2db46ad0', 'f1989782-88f9-4055-99fc-135611c1992a')
    ).rejects.toThrow(NotFoundException);
  });
...
describe('delete', () => {
  ...
  it('should throw an exception if comment id is not correct', async () => {
    ...
    jest.spyOn(mockRepository, 'getById').mockResolvedValue(null);
    await expect(
      service.deleteComment('3ac84483-20f1-47f3-8be1-43ab2db46ad0', 'f1989782-88f9-4055-99fc-135611c1992a')
    ).rejects.toThrow(NotFoundException);
  });
  ...
  it('should throw an exception if user is not the author of the comment', async () => {
    ...
    jest.spyOn(mockRepository, 'getById').mockResolvedValue(new PostDTO(comment1));
    jest.spyOn(mockRepository, 'delete').mockResolvedValue(new PostDTO(comment1));
    await expect(service.deleteComment('wrong', 'f1989782-88f9-4055-99fc-135611c1992a')).rejects.toThrow(
      ForbiddenException
    );
  });
});
...
describe('getCommentsByAuthor', () => {
  it('should get all comments, by author id', async () => {
    ...
    const recieved = await service.getCommentsByAuthor(
  ...
  it('should throw an exception if user id is not correct', async () => {
    ...
    jest.spyOn(userMockRepository, 'getById').mockResolvedValue(null);
    await expect(
      service.getCommentsByAuthor('3ebbfea7-3ae5-411c-aae8-049ff04db067', '3ac84483-20f1-47f3-8be1-43ab2db46ad0')
    ).rejects.toThrow(NotFoundException);
  });
});
...
describe('getCommentByPostIdCursorPaginated', () => {
  it('should get all comments of a given post', async () => {
    ...
    const recieved = await service.getCommentByPostIdCursorPaginated(
      '30eed46e-294e-4547-ae37-749728575bda',
      '3ac84483-20f1-47f3-8be1-43ab2db46ad0',
      {}
    );
  ...
  it('should throw an exception if post id is not correct', async () => {
    ...
    jest.spyOn(postMockRepository, 'getById').mockResolvedValue(null);
    await expect(
      service.getCommentByPostIdCursorPaginated(
        '30eed46e-294e-4547-ae37-749728575bda',
        '3ac84483-20f1-47f3-8be1-43ab2db46ad0',
        {}
      )
