...
beforeEach(() => {
  ...
  follow1 = {
    id: '23e0ee80-5b2b-4dd7-b31d-80a91156ae95',
  ...
  follow2 = {
    id: '24833729-82fa-44ad-bb90-1ad0e11c73b1',
...
describe('followUser', () => {
  it('should make the user follow an unfollowed user', async () => {
    ...
    const recieved = await service.followUser(
  ...
  it('should throw an exception if followed id is not valid', async () => {
    ...
    await expect(
      service.followUser('83538af2-24e4-4435-bc36-a049183828d8', '3ac84483-20f1-47f3-8be1-43ab2db46ad0')
...
describe('unfollowUser', () => {
  it('should make the user unfollow an followed user', async () => {
    ...
    const recieved = await service.unfollowUser(
      '83538af2-24e4-4435-bc36-a049183828d8',
      '3ac84483-20f1-47f3-8be1-43ab2db46ad0'
    );
    expect(expected.id).toEqual(recieved.id);
  ...
  it('should throw an exception if followed id is not valid', async () => {
    ...
    jest.spyOn(userMockRepository, 'getById').mockResolvedValue(null);
    await expect(
      service.unfollowUser('83538af2-24e4-4435-bc36-a049183828d8', '3ac84483-20f1-47f3-8be1-43ab2db46ad0')
    ).rejects.toThrow(NotFoundException);
  });
...
describe('isFollowing', () => {
  it('should return a true if the user is following another user', async () => {
    ...
    jest.spyOn(mockRepository, 'getFollowId').mockResolvedValue('23e0ee80-5b2b-4dd7-b31d-80a91156ae95');
    const expected = true;
    const recieved = await service.isFollowing(
      '83538af2-24e4-4435-bc36-a049183828d8',
      '3ac84483-20f1-47f3-8be1-43ab2db46ad0'
    );
  ...
  it('should throw an exception if followed id is not valid', async () => {
    ...
    jest.spyOn(userMockRepository, 'getById').mockResolvedValue(null);
    await expect(
      service.isFollowing('83538af2-24e4-4435-bc36-a049183828d8', '3ac84483-20f1-47f3-8be1-43ab2db46ad0')
    ).rejects.toThrow(NotFoundException);
  });
});
